...
def _scaffold_files(relative, project_id):
    ...
    return {
        ...
        f"{relative}/30 Handoffs/README.md": "# Handoffs\n\nUse `YYYY-MM-DD--TASK-001--member.md`. Record outcome, bundle ID, actual verification evidence summary, open risks, next owner, and canonical Notion/Git links. Exclude raw agent transcripts, credentials, private paths, and customer data. Neither a handoff nor an AI review constitutes business acceptance.\n",
